...
const SearchSection: React.FC<SearchSectionProps> = ({ onSearchSubmit }) => {
  ...
  return (
    <section className="py-12 md:py-16 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden w-full">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex justify-center mt-8 md:mt-12">
          <img 
            ...
            className="rounded-lg shadow-lg w-full max-w-full h-auto max-h-72 md:max-h-96 object-cover"
          />
        </div>
      </div>
    </section>
