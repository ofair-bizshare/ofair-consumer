...
const Index = () => {
  ...
  return <div className="flex flex-col min-h-screen" dir="rtl">
      ...
      {/* Hero Section - Updated with better visuals and a clear illustration */}
      <section className="relative pt-28 pb-16 md:pt-32 md:pb-24 overflow-hidden">
        ...
        {/* New illustration background with proper image */}
        <div className="absolute inset-0 z-[-1] opacity-30 bg-[url('https://images.unsplash.com/photo-1581088778472-1393d6026d51?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center"></div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-start lg:items-start gap-8">
            ...
            {/* Right side - Prominently displayed illustration and form */}
            <div className="w-full lg:w-1/2 animate-fade-in pt-0 relative z-10">
              {/* Main illustration */}
              <div className="mb-6 p-2 bg-white/50 backdrop-blur-sm rounded-xl shadow-lg hidden lg:block">
                <img 
                  src="https://images.unsplash.com/photo-1590479773265-7464e5d48118?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80" 
                  alt="צוות מקצועי בפעולה" 
                  className="rounded-lg shadow-md w-full h-auto object-cover max-h-64"
                />
              </div>
