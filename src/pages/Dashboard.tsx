...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen" dir="rtl">
      <Helmet>
        <title>האזור האישי שלי | oFair - ניהול הפניות, אנשי הקשר והתראות</title>
        <meta name="description" content="צפה בפניות הקודמות שלך, אנשי הקשר השמורים, והסטטוס של הפרויקטים שלך באזור האישי." />
        <meta name="keywords" content="אזור אישי, פניות, אנשי קשר, התראות, ניהול פרויקטים, בעלי מקצוע, סטטוס פרויקט" />
      </Helmet>
        ...
        <div className="container mx-auto px-6">
          <div className="mb-10">
            ...
            <p className="text-gray-600">
              צפה בפניות המקצועיות, אנשי הקשר השמורים והתראות שלך
            </p>
          </div>
